    ...
    public class LoginController : ControllerBase
    {
        ...
        public IActionResult Authenticate(LoginUser userParam)
        {
            ...
            if (user != null && passwordHasher.VerifyHashMatch(user.PasswordHash, userParam.Password, user.Salt))
            {
                ...
                LoginResponse retUser = new LoginResponse() { User = new ReturnUser() { UserId = user.UserId, Username = user.Username, Role = user.Role, IsPremium = user.IsPremium}, Token = token };
        ...
        public IActionResult Register(RegisterUser userParam)
        {
            ...
            User user = userDao.AddUser(userParam.Username, userParam.Password, userParam.EmailAddress);
            if (user != null)
            {
